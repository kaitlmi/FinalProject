...
ifi = Screen('GetFlipInterval', window);
table = imread('Background.png'); % table background
...
Screen('DrawTexture', window, imageTexture_table, [], [0, 0, screenXpixels, screenYpixels], 0); % Added
DrawFormattedText(window, 'press enter to continue', 'center', .1*screenYpixels, white); % Added
