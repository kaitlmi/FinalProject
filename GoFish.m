...
for n = 1:9
    if Your_cards_num(n) <= 13 
        Your_cards_num == "clubs"
    elseif Your_cards_num(n) >= 14 && Your_cards_num(n) <= 26
        Your_cards_num == "hearts"
    elseif Your_cards_num(n) >= 27  
        Your_cards_num == "diamonds"
    else 
        Your_cards_num == "spades"
for n= 1:9
    if Your_cards(n) == "1"
        Your_cards(n) = "Ace";
